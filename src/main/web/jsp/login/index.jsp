		...
		<div class='login'>
			...
			<div class='login_fields'>
				...
				<div class='login_fields__password'>
					...
					<input name="password" value="666666" id="password" placeholder='请输入密码' maxlength="16" type='text' autocomplete="off">
					<div class='validation'>
				...
				<div class='login_fields__password'>
					...
					<div class='validation' style="opacity: 1; right: -5px;top: -3px;">
						<img src="<%=basePath%>util/code" id="codeimg" onclick="changeimg(this)">
					</div>
				</div>
